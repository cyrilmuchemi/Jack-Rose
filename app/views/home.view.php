...
<html lang="en">
    ...
    <head>
        ...
        <!-- Google Web Fonts -->
        <link rel="preconnect" href="<?=ROOT?>/assets/https://fonts.googleapis.com">
        <link rel="preconnect" href="<?=ROOT?>/assets/https://fonts.gstatic.com" crossorigin>
        <link href="<?=ROOT?>/assets/https://fonts.googleapis.com/css2?family=Great+Vibes&family=Open+Sans:wght@400;500;600&family=Petit+Formal+Script&display=swap" rel="stylesheet"> 

        <!-- Icon Font Stylesheet -->
        <link rel="stylesheet" href="<?=ROOT?>/assets/https://use.fontawesome.com/releases/v5.15.4/css/all.css"/>
        <link href="<?=ROOT?>/assets/https://cdn.jsdelivr.net/npm/bootstrap-icons@1.4.1/font/bootstrap-icons.css" rel="stylesheet">
    ...
    <body data-bs-spy="scroll" data-bs-target="#navBar" id="weddingHome">
            ...
            <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img src="<?=ROOT?>/assets/img/carousel-1.jpg" class="img-fluid" alt="Image">
        ...
        <div class="container-fluid position-relative overflow-hidden bg-secondary py-5">
            <img src="<?=ROOT?>/assets/img/bg-flower.png" class="img-fluid position-absolute top-0" style="right: -15px; transform: rotate(270deg); opacity: 0.5;" alt="">
            <img src="<?=ROOT?>/assets/img/bg-flower.png" class="img-fluid position-absolute" style="bottom: 10px; left: -15px; transform: rotate(90deg); opacity: 0.5;" alt="">
                ...
                <div class="row g-5 align-items-center">
                    <div class="col-xl-6 wow fadeIn" data-wow-delay="0.1s">
                        <div class="border-white bg-primary" style="border-style: double;">
                            <img src="<?=ROOT?>/assets/img/about-1.jpg" class="img-fluid w-100" alt="">
                        </div>
                    </div>
                    <div class="col-xl-6">
                                    ...
                                    <div id="tab-1" class="tab-pane fade show p-0 active">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="d-flex">
                                                    <div class="me-4">
                                                        <img src="<?=ROOT?>/assets/img/bride.jpg" class="img-fluid w-100 img-border" alt="">
                                                    </div>
                                    ...
                                    <div id="tab-2" class="tab-pane fade show p-0">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="d-flex">
                                                    <div class="me-4">
                                                        <img src="<?=ROOT?>/assets/img/Groom.jpg" class="img-fluid w-100 img-border" alt="">
                                                    </div>
                                                    <div class="text-start my-auto">
                ...
                <div class="row g-5 justify-content-center text-center">
                    ...
                    <div class="col-12 wow fadeIn" data-wow-delay="0.2s">
                        <div class="border-secondary" style="border-style: double;">
                            <iframe class="w-100" 
                            style="height: 450px; margin-bottom: -6px;" src="<?=ROOT?>/assets/https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d387191.33750346623!2d-73.97968099999999!3d40.6974881!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xc80b8f06e177fe62!2sNew%20York%2C%20NY%2C%20USA!5e0!3m2!1sen!2sbd!4v1694259649153!5m2!1sen!2sbd" 
    ...
    <script src="<?=ROOT?>/assets/https://ajax.googleapis.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
    <script src="<?=ROOT?>/assets/https://cdn.jsdelivr.net/npm/bootstrap@5.0.0/dist/js/bootstrap.bundle.min.js"></script>
