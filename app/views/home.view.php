...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Mr&Mrs - Wedding Bootstrap Template</title>
        ...
        <link href="<?=ROOT?>/assets/lib/animate/animate.min.css" rel="stylesheet">
    ...
    <style>       
        @font-face {
            ...
            src: url('<?=ROOT?>/assets/project-fonts/Great_Vibes/GreatVibes-Regular.ttf') format('woff2');
        }
        @font-face {
            font-family: 'Open Sans';
            src: url('<?=ROOT?>/assets/project-fonts/Open_Sans/OpenSans-Italic-VariableFont_wdth,wght.ttf') format('woff2');
        }
       @font-face {
            font-family: 'Petit Formal Script';
            src: url('<?=ROOT?>/assets/project-fonts/Petit_Formal_Script/PetitFormalScript-Regular.ttf') format('woff2');
        }
    </style>
    <body data-bs-spy="scroll" data-bs-target="#navBar" id="weddingHome">
                    ...
                    <?php if(!empty($gallery)) :?>
                        <?php foreach($gallery as $image_row) :?>
                            <div class="carousel-item active">
                                <img src="<?=get_image($image_row->image)?>" class="img-fluid" alt="Image">
        ...
        <div class="container-fluid position-relative py-5" id="weddingAbout">
            <div class="position-absolute" style="top: -35px; right: 0;">
                <img src="<?=ROOT?>/assets/img/tamp-bg-1.png" class="img-fluid" alt="">
            </div>
...
<div class="container-fluid position-relative overflow-hidden bg-secondary py-5">
    <img src="<?=ROOT?>/assets/img/bg-flower.png" 
        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-xl-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="border-white bg-primary" style="border-style: double;">
                    <img src="<?= get_image($about_main->image ?? '') ?>" 
            ...
            <div class="col-xl-6">
                <div class="wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <h1 class="display-5 text-white mb-4">
                        <?= escape($about_main->about_title ?? '') ?>
                    </h1>

                    <p class="text-white fs-5 mb-4">
                        <?= nl2br(escape($about_main->about_description ?? '')) ?>
                    </p>
                    ...
                    <div class="tab-class bg-primary p-4">
                        <ul class="nav d-flex mb-4">
                            ...
                            <?php foreach ($people as $i => $person): ?>
                                <li class="nav-item mx-2">
                                    <a class="d-flex py-2 text-center bg-white <?= $i == 0 ? 'active' : '' ?>" 
                                       data-bs-toggle="pill" 
                                       href="#tab-<?= $person->id ?>">
                                        <span class="text-dark" style="width:150px;">
                                            <?= ucfirst($person->role) ?> Info
                                        </span>
                                    </a>
                                </li>
                            <?php endforeach; ?>
                        ...
                        <div class="tab-content">
                            ...
                            <?php foreach ($people as $i => $person): ?>
                                <div id="tab-<?= $person->id ?>" 
                                     class="tab-pane fade show p-0 <?= $i == 0 ? 'active' : '' ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="d-flex">
                                                ...
                                                <!-- Person Image -->
                                                <div class="me-4">
                                                    <img src="<?= get_image($person->image) ?>" 
                                                         class="img-fluid w-100 img-border" alt="">
                                                </div>
                                                ...
                                                <div class="text-start my-auto">
                                                    ...
                                                    <p class="text-white mb-3">
                                                        <?= nl2br(escape($person->person_description)) ?>
                                                    </p>

                                                    <!-- Social Links -->
                                                    <div class="d-flex">
                                                        <?php if ($person->facebook_link): ?>
                                                            <a href="<?= $person->facebook_link ?>" 
                                                        ...
                                                        <?php if ($person->instagram_link): ?>
                                                            <a href="<?= $person->instagram_link ?>" 
                                                               class="btn btn-primary btn-primary-outline-0 btn-sm-square me-2">
...
<!-- About End -->
                ...
                <div class="story-timeline">
                    <div class="row wow fadeInUp" data-wow-delay="0.2s">
                        <div class="col-md-6 text-end border-0 border-top border-end border-secondary p-4">
                            <div class="d-inline-flex align-items-center h-100">
                                <img src="<?=ROOT?>/assets/img/story-1.jpg" class="img-fluid w-100 img-border" alt="">
                            </div>
                        </div>
                    ...
                    <div class="row flex-column-reverse flex-md-row wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <div class="col-md-6 border-start border-top border-secondary p-4">
                            <div class="d-inline-flex align-items-center h-100">
                                <img src="<?=ROOT?>/assets/img/story-2.jpg" class="img-fluid w-100 img-border" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="row wow fadeInUp" data-wow-delay="0.4s">
                        <div class="col-md-6 text-end border-end border-top border-secondary p-4 ps-0">
                            <div class="d-inline-flex align-items-center h-100">
                                <img src="<?=ROOT?>/assets/img/story-3.jpg" class="img-fluid w-100 img-border" alt="">
                            </div>
                        </div>
                        <div class="col-md-6 border-start border-top border-secondary p-4 pe-0">
                            <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-4">
                    ...
                    <div class="row flex-column-reverse flex-md-row wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="col-md-6 border border-end-0 border-secondary p-4">
                            <div class="d-inline-flex align-items-center h-100">
                                <img src="<?=ROOT?>/assets/img/story-4.jpg" class="img-fluid w-100 img-border" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container py-5 wow zoomIn" data-wow-delay="0.1s">
                <div class="wedding-date text-center bg-light p-5" style="border-style: double !important; border: 15px solid rgba(253, 93, 93, 0.5);">
                    ...
                    <div class="position-absolute" style="top: 15%; right: -30px; transform: rotate(320deg); opacity: 0.5; z-index: 1;">
                        <img src="<?=ROOT?>/assets/img/attendance-bg.png" class="img-fluid" alt="">
                    </div>
        ...
        <div class="container-fluid wedding-timeline bg-secondary position-relative overflow-hidden py-5" id="weddingTimeline">
            <div class="position-absolute" style="top: 50%; left: -100px; transform: translateY(-50%); opacity: 0.5;">
                <img src="<?=ROOT?>/assets/img/wedding-bg.png" class="img-fluid" alt="">
            </div>
                ...
                <div class="row g-4">
                        ...
                        <div class="team-item">
                            <div class="team-img">
                                <div class="team-img-main">
                                    <img src="<?=ROOT?>/assets/img/bridesmaid-1.png" class="img-fluid w-100" alt="">
                                </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="team-item">
                            <div class="team-img">
                                <div class="team-img-main">
                                    <img src="<?=ROOT?>/assets/img/bridesmaid-team-2.png" class="img-fluid w-100" alt="">
                                </div>
                                <div class="team-img-bg position-absolute" style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                                    <img src="<?=ROOT?>/assets/img/team-1-bg.png" class="img-fluid" alt="">
                                </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="team-item">
                            <div class="team-img">
                                <div class="team-img-main">
                                    <img src="<?=ROOT?>/assets/img/bridesmaid-3.png" class="img-fluid w-100" alt="">
                                </div>
                                <div class="team-img-bg position-absolute" style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                                    <img src="<?=ROOT?>/assets/img/team-1-bg.png" class="img-fluid" alt="">
                                </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                        <div class="team-item">
                            <div class="team-img">
                                <div class="team-img-main">
                                    <img src="<?=ROOT?>/assets/img/bridesmaid-4.png" class="img-fluid w-100" alt="">
                                </div>
                                <div class="team-img-bg position-absolute" style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                                    <img src="<?=ROOT?>/assets/img/team-1-bg.png" class="img-fluid" alt="">
                                </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-item">
                            <div class="team-img">
                                <div class="team-img-main">
                                    <img src="<?=ROOT?>/assets/img/Groomsmen-1.png" class="img-fluid w-100" alt="">
                                </div>
                                <div class="team-img-bg position-absolute" style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                                    <img src="<?=ROOT?>/assets/img/team-1-bg.png" class="img-fluid" alt="">
                                </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="team-item">
                            <div class="team-img">
                                <div class="team-img-main">
                                    <img src="<?=ROOT?>/assets/img/groomsmen-2.png" class="img-fluid w-100" alt="">
                                </div>
                                <div class="team-img-bg position-absolute" style="bottom: -30px; left: -100px; transform: rotate(50deg); z-index: 1;">
                                    <img src="<?=ROOT?>/assets/img/team-1-bg.png" class="img-fluid" alt="">
                                </div>
                ...
                <div class="row g-5 justify-content-center">
                    ...
                    <div class="col-lg-4 text-center">
                        <div class="footer-item">
                            ...
                            <div class="btn-link d-flex justify-content-center">
                                <a href="<?= $social_links->facebook_link ?? '#'?>" class="btn btn-md-square btn-light btn-light-outline-0 me-2"><i class="fab fa-facebook-f"></i></a>
                                <a href="<?= $social_links->twitter_link ?? '#'?>" class="btn btn-md-square btn-light btn-light-outline-0 me-2"><i class="fab fa-twitter"></i></a>
                                <a href="<?= $social_links->instagram_link ?? '#'?>" class="btn btn-md-square btn-light btn-light-outline-0 me-2"><i class="fab fa-instagram"></i></a>
                                <a href="<?= $social_links->linkedin_link ?? '#'?>" class="btn btn-md-square btn-light btn-light-outline-0 me-0"><i class="fab fa-linkedin-in"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 text-end">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a target="blank" href="<?= $social_links->facebook_link ?? '#'?>" class="btn-link"> Facebook</a>
    ...
    <script src="<?=ROOT?>/assets/bootstrap-5.3.8-dist/js/bootstrap.bundle.min.js"></script>
    <script src="<?=ROOT?>/assets/lib/wow/wow.min.js"></script>
